    ...
    class FormSteps {
        ...
        updateForm() {
            ...
            if (this.currentStep == 3) {
                ...
                for (var i = 0; i < checkboxes.length; i++) {
                    checkboxes_arr.push(checkboxes[i].value)
                }

                $.ajax('/get_institution_by_category/', {data:{'cat_ids':checkboxes_arr}, traditional:true, success:function(data, status)
                    {
            ...
            if (this.currentStep == 5) {
                var institution = document.querySelectorAll('input[name=institutions]:checked')

                $.ajax('get_institution_and_category', {data: {'cat_ids': checkboxes_arr, 'inst_ids': institution}, traditional:true, success:function(data, status)
                    {
                        $("#")
                    }
                })
